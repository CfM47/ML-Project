...
Durante la evaluación, se utilizan las representaciones del espacio latente generadas por el autoencoder en lugar de la reconstrucción directa. Se entrena un clasificador One-Class SVM sobre los embeddings de las máscaras reales para aprender la distribución de estructuras topológicamente válidas. La métrica reportada corresponde a la proporción de máscaras predichas que son identificadas como ``inliers'' por este modelo. Esto permite cuantificar cuántas predicciones mantienen una coherencia estructural indistinguible de las máscaras de referencia, penalizando aquellas con artefactos o formas anómalas. Esta métrica complementa a IoU y Dice al evaluar la calidad global de la forma más allá de la coincidencia píxel a píxel.
