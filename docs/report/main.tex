...
Para complementar los resultados cuantitativos, se realizó una evaluación visual sobre el conjunto de prueba independiente. Para este análisis, se seleccionó el par modelo-estrategia que demostró el mayor rendimiento global según la métrica F1-score: el \textbf{Swin Transformer Estándar} entrenado con la estrategia de \textbf{Aumentación Combinada (2 Geom, 2 Fotom, 1 SEM)}.
